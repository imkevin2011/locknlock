<template>
    <div id="root-nav">
        <div class="background-one link-container">
            <router-link to="/home" :class="'link-one'" push>主页</router-link>
        </div>
        <div class="background-two link-container">
            <router-link to="/projects" :class="'link-two'" push>项目</router-link>
        </div>
        <div class="background-three link-container">
            <router-link to="/backend" :class="'link-three'" push>后台</router-link>
        </div>
    </div>
</template>
...
<style scoped>
    ...
    .link-one::before {
        ...
        transition: clip-path .5s cubic-bezier(0.65, 0, 0.35, 1);
    }
